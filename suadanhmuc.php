    ...
    <div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="xl_updatedm.php" method="POST" >
					<div class="wrap-input100 validate-input m-b-26">
                    <input type="hidden" name="id" value="<?php echo $ID; ?>">
						<span class="label-input100">Tên danh mục</span>
						<input class="input100" type="text" name="category" id="" placeholder="Tên danh mục" value="<?php echo $row['category']; ?>">
						<span class="focus-input100"></span>
					</div>

					<div class="container-login100-form-btn">

                    <input type="submit" value="Cập nhật" class="login100-form-btn">
					</div>
				</form>
			</div>
		</div>
